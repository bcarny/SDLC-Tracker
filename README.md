...
![Organization picker](docs/images/org-picker.png)
*Organization picker or get started*

![Applications](docs/images/applications.png)
*Applications view with maturity scores*

![Application detail](docs/images/application-detail.png)
*Application detail and assessments*

![Comparison](docs/images/comparison.png)
*Comparison (radar chart and score table)*
...
Screenshots can be regenerated by running `npm run dev`, then `npm run screenshots` in another terminal. Ensure Chromium is installed: `npm run screenshots:install`.
